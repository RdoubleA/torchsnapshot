...
class TensorEntry(Entry):
    ...
    Attributes:
        location (str): location of the Tensor object in the state dict. For example,
            "0/module/output.weight" would mean the Tensor is the weight of the nn.Module named output,
            which is an attribute of the root module and is present on rank 0.
